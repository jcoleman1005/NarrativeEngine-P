...
import { countRegisterTokens, EMPTY_REGISTER, CATEGORY_LABELS, getEntriesForNpc } from '../../services/divergenceRegister';
...
export function MemoryTab() {
    ...
    const regTokens = countRegisterTokens(reg, chapters);
